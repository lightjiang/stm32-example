...
## MERCHANTABILITY or FITNESS FOR A PAbuildtool/rules.mkRTICULAR PURPOSE.  See the
...
%.flash: %.hex
	...
	$(Q)$(OOCD) $(OOCDFLAGS) -c init -c halt -c "flash write_image erase $(*).hex" -c reset -c shutdown 
